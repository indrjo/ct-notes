...
Rather than thinking diagrams abstractly --- like in the form stated in
the definition ---, one usually draws them. In general, it is not a good
idea to draw all the compositions. For example, consider four nodes
and three arcs displayed as
\[
  ...
  \end{tikzcd}
\]
and draw all the compositions: you will convince yourself it may be a
huge mess even for small diagrams. In fact, why waste an arrow to
...
identities need to be drawn: we know every object has one and only one
identity and thus the presence of an object automatically carries the
presence of its identity.
