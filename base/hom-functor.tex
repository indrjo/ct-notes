...
In a locally small \NotaInterna{have we defined somewhere that?} category \(\cat C\), take two morphisms
\[\begin{tikzcd}
a_1 \\
b_1 \ar["g_1", u]
...
%that is \(f\) is mapped to the identity function on \(\cat C (a_1, b_1)\).
