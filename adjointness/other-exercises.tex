...
\begin{exercise}[Exponential objects]\label{exercise:ExponentialObject}
...
\begin{exercise}[On subobject classifiers, again]
  \YetToBeTeXed{} %Refer to Exercise~\ref{exercise:SubobjectClassifiersI}. \NotaInterna{To be continued\dots{}}
\end{exercise}
