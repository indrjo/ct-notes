...
%
\item \NotaInterna{The converse, epic \(\tto\) surjective, under additional assumptions about \(\cat C\) requires some work which is not trivial. Decompose in smaller part and let the reader draw the conclusion.}
\end{tcbenum}
\end{exercise}
